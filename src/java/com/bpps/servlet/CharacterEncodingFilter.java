...
public class CharacterEncodingFilter implements Filter {
	...
	if (debug) log("CharacterEncodingFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("CharacterEncodingFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("CharacterEncodingFilter:doFilter()");
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("CharacterEncodingFilter: Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("CharacterEncodingFilter()");
	StringBuffer sb = new StringBuffer("CharacterEncodingFilter(");
	...
	public void setParameter(String name, String []values) {
	    if (debug) System.out.println("CharacterEncodingFilter::setParameter(" + name + "=" + values + ")" + " localParams = "+ localParams);
	...
	public String getParameter(String name) {
	    if (debug) System.out.println("CharacterEncodingFilter::getParameter(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public String[] getParameterValues(String name) {
	    if (debug) System.out.println("CharacterEncodingFilter::getParameterValues(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public Enumeration getParameterNames() {
	    if (debug) System.out.println("CharacterEncodingFilter::getParameterNames() localParams = " + localParams);
	    if (localParams == null)
	...
	public Map getParameterMap() {
	    if (debug) System.out.println("CharacterEncodingFilter::getParameterMap() localParams = " + localParams);
	    if (localParams == null)

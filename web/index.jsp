...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN">
    <head>
        ...
        <link rel="stylesheet" href="ui/dropdown/dropdown.css" type="text/css" media="screen, projection" />
        ...
        <div id="page">
            ...
            <table id="mainTable" >
                <tr>
                    ...
                    <td><%@include file="/WEB-INF/jspf/main.jspf"%></td>
                </tr>
            </table>
        </div>

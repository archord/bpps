...
<%@page import="com.bpps.pojo.PositionDisease" %>
<%
    ...
    <div id="page">
      <div id="article_header">
        <%          if (posId != null && !posId.isEmpty()) {
            ...
            Position tpos = positionDAO.getPositionById(Integer.parseInt(posId));
            out.print(tpos.getPosName() + "病害列表");
          } else {
            out.print("病害列表");
          }
        %>
      ...
      <div id="article_content" style="text-align: center;">
        <%
          if (labelIdStr != null && disType != null && posId != null && !labelIdStr.isEmpty() && !disType.isEmpty() && !posId.isEmpty()) {
            ...
            List<Disease> diseases = pdDao.getDiseasesByPosId(Integer.parseInt(posId),Integer.parseInt(disType));

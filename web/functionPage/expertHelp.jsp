...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN">
    <head>
        <title>黄瓜主要病害标准化远程智能诊断系统——专家协助信息列表</title>
        ...
        <style type="text/css">
            <!--
            div#mainCenter table#detail th{text-align: right;width: 100px}
            div#mainCenter table#detail td{text-align: left;width: 195px}
            -->
        </style>
    </head>
    <body>
        <div id="page">
            ...
            <table id="mainTable" >
                <tr>
                    ...
                    <td><%@include file="/WEB-INF/jspf/expertHelp.jspf"%></td>
                </tr>
            </table>
        </div>

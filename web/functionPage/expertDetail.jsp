...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN">
    <head>
        <title>农作物病虫害诊断与防治决策系统——专家详细介绍</title>
        ...
        <style type="text/css">
            <!--
            div#mainCenter table#detail th{text-align: right;width: 80px; font-weight: bold}
            div#mainCenter table#detail td{text-align: left;color: #000;}
            -->
        </style>
    </head>
    <body>
        <div id="page">
            ...
            <table id="mainTable" >
                <tr>
                  <td width="182px"><%@include file="/WEB-INF/jspf/left.jspf"%></td>
                    <td><%@include file="/WEB-INF/jspf/expertDetail.jspf"%></td>
                </tr>
            </table>
        </div>
